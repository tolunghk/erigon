...
var (
	...
	MergeDevnetGenesisHash = common.HexToHash("0x97bd4312dfa0f247e7199b59f243673d45934f3071be44174e007d56d29ada2b")
...
var (
	...
	MergeDevnetChainConfig = &ChainConfig{
		ChainName:               "merge-devnet3",
		ChainID:                 big.NewInt(1337602),
		Consensus:               EtHashConsensus,
		HomesteadBlock:          big.NewInt(0),
		EIP150Block:             big.NewInt(0),
		EIP155Block:             big.NewInt(0),
		...
		TerminalTotalDifficulty: big.NewInt(5000000000),
		Ethash:                  new(EthashConfig),
	}
